...
namespace SV22T1020375.Admin
{
    ...
    public static class ApplicationContext
    {
        ...
        public static int PageSize
        {
            get
            {
                // Thay vì dùng Convert.ToInt32 dễ gây lỗi, ta dùng int.TryParse
                // Nếu lấy được giá trị từ config và chuyển thành số nguyên thành công, dùng số đó.
                if (int.TryParse(GetConfigValue("PageSize"), out int pageSize))
                {
                    return pageSize;
                }

                // Trị tận gốc: Nếu thiếu cấu hình trong file appsettings.json hoặc dữ liệu bị sai định dạng, 
                // hệ thống sẽ tự động gán giá trị mặc định là 20 để tránh crash web.
                return 20;
            }
        }
    }
